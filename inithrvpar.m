...
switch project_name   
    ...
    case 'SeminarskiADS'                   % Update with your project name
...
% SampEn an ApEn 
HRVparams.Entropy.on = 0;                     % Default: 1, MSE Analysis 1=On or 0=Off
...
HRVparams.output.format = 'mat';        % 'csv' - creates csv file for output
...
HRVparams.output.ann_format = 'csv'; % 'binary'  = binary annotation file generated
